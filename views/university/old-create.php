...
function CreateSpecialityBlock(parentId, parentDOMElement) {
    ...
    console.log("SPECIALITY BTN VAL: "+parentId);
...
function CreateSpeciality(event, specialities, sName = "", sGeneralInfo = "", sInstructions = "", sExaminations = "", sDegree = 1) {
    ...
    specialityName.name = "SpecialityName["+nestedId+"][]";
    ...
    specialityDescription.name = "SpecialityDescription["+nestedId+"][]";
    ...
    specialityInstructions.name = "SpecialityInstructions["+nestedId+"][]";
    ...
    specialityExamMaterial.name = "SpecialityExamMaterial["+nestedId+"][]";
    ...
    specialityDegree.name = "SpecialityDegree["+nestedId+"][]";
    ...
    CreateStudyModuleBlock(nestedId, specialityContainer);
...
function CreateStudyModuleBlock(parentId, parentDOMElement) {
    ...
    console.log("STUDY MODULE BTN VAL: "+parentId);
...
function CreateStudyModule(event, studyModules, sMName = "") {
    ...
    studyModuleName.name = "StudyModuleName["+nestedId+"][]";
...
function CreateCourseBlock(parentId, parentDOMElement) {
    ...
    console.log("COURSE BTN VAL: "+parentId);
